...
const ShopCard: React.FC<ShopCardProps> = ({ imageUrl, price, discount }) => {
  return (
    <div className="w-[250px] h-[350px] border border-black rounded-2xl px-4 py-4 flex flex-col items-center">
      ...
      {/* Add to Cart Button */}
      <button className="mt-auto bg-[#C93838] text-[#E7DAD1] text-lg hover:text-[#E7DAD1] hover:bg-[#9D2A2A] w-full py-2 rounded-xl font-bowlby">
        Add to Cart
      </button>
    </div>
  );
